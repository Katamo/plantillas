const __resolved__virtual_storySource_srcComposablesUseMultiSelectionUsemultiselectionStoryVue = `<script setup>
...
`;
export {
  __resolved__virtual_storySource_srcComposablesUseMultiSelectionUsemultiselectionStoryVue as default
};
