  ...
  routes: [
    {
      path: "/",
      name: "home",
      component: () => __vitePreload(() => import("./HomeView.vue-Dl_JOn5d.js"), true ? __vite__mapDeps([9,10,1]) : void 0)
    },
    {
      path: "/story/:storyId",
      name: "story",
      component: () => __vitePreload(() => import("./StoryView.vue-CRrwbUyE.js"), true ? __vite__mapDeps([11,1,10,12,13,14]) : void 0)
    }
  ]
});
