  ...
  routes: [
    {
      path: "/",
      name: "home",
      component: () => __vitePreload(() => import("./HomeView.vue-DcHZJhl2.js"), true ? __vite__mapDeps([9,10,1]) : void 0)
    },
    {
      path: "/story/:storyId",
      name: "story",
      component: () => __vitePreload(() => import("./StoryView.vue-BZwH_V5j.js"), true ? __vite__mapDeps([11,1,10,12,13,14]) : void 0)
    }
  ]
});
