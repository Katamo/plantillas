const __resolved__virtual_storySource_srcComponentsDataDataTableCDataTableStoryVue = `<script setup>
...
`;
export {
  __resolved__virtual_storySource_srcComponentsDataDataTableCDataTableStoryVue as default
};
